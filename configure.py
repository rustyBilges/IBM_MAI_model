...
ITERATIONS = 3000 #10000 #50000 #5000
...
#SRC_NET_FILE = 'initial_network_E.graphml'
SRC_NET_FILE = 'initial_network.graphml'
SPECIES = 60 #3 #60

REPRODUCTION_RATE = 0.0100000
MUTUALISM = 1.0
HABITAT_LOSS_TYPE = 1
INMIGRATION = 0.001 #0.0001#0.005    #0.001
LOST_HABITAT = 0.0
